...
export const fr: Dictionary = {
  ...
  home: {
    hero: {
      eyebrow: "Entreprise logicielle · Produits & solutions sur mesure",
      title1: "Un logiciel qui fait",
      titleAccent: "tourner",
      title2: "votre entreprise. Prêt ou bâti pour vous.",
      sub: "ESTINAD est une entreprise logicielle. Nous vendons des logiciels métier prêts à l'emploi — caisse, stocks, restauration, RH et facturation — et nous bâtissons des logiciels sur mesure, des sites web et des écosystèmes numériques complets pour les clients. Un seul partenaire pour les produits que vous achetez et les systèmes que nous bâtissons.",
      cta1: "Explorer les produits →",
      cta2: "Discuter de votre projet",
      cta3: "Demander une démo →",
      built: "Produits sur le marché",
      designed: "Capacité de livraison sur mesure",
      monoCaption: "ESTINAD · entreprise logicielle · produits + solutions sur mesure",
    },
    trust: {
      eyebrow: "La confiance des secteurs opérationnels",
      stats: [
        { value: "5+", label: "Produits logiciels prêts" },
        { value: "4", label: "Secteurs servis" },
        { value: "Conçu en Algérie", label: "Pour le MENA et au-delà" },
        { value: "De bout en bout", label: "Produits, travaux sur mesure & écosystèmes" },
      ],
      sectors: ["Commerce", "Restauration", "Pharmacies", "Cliniques", "PME", "Multi-sites"],
    },
    whoIs: {
      eyebrow: "Qui est ESTINAD",
      title: "Une entreprise logicielle — pas juste un produit, pas juste une agence.",
      intro:
        "ESTINAD fait deux choses, clairement. Nous créons et vendons des produits logiciels prêts sur lesquels les entreprises s'appuient. Et nous concevons et livrons des logiciels sur mesure, des sites web et des écosystèmes numériques complets pour les clients qui ont besoin de quelque chose de bâti pour eux. La même discipline d'ingénierie alimente les deux côtés.",
      pillars: [
        { t: "Produits prêts", d: "Des logiciels métier que vous pouvez adopter aujourd'hui — caisse & stocks, restauration, RH et facturation — bâtis sur une plateforme disciplinée." },
        { t: "Solutions sur mesure", d: "Quand un produit ne suffit pas, nous bâtissons l'application, le site ou le système dont votre entreprise a réellement besoin — de bout en bout." },
        { t: "Écosystèmes numériques", d: "Nous connectons produits, travaux sur mesure et intégrations dans un système cohérent qui évolue avec l'entreprise." },
        { t: "Partenaire de long terme", d: "Nous restons après le lancement — support, évolution et croissance du logiciel au fil de l'entreprise et de ses marchés." },
      ],
    },
    productsOverview: {
      eyebrow: "Produits",
      title: "Logiciel prêt, par fonction de l'entreprise.",
      intro:
        "Chaque produit ESTINAD est conçu pour un secteur et unifié par une plateforme en dessous. Commencez avec un. Ajoutez-en un autre sans re-platformer.",
    ...
    solutionsOverview: {
      ...
      intro: "ESTINAD rejoint chaque opérateur là où il en est — par secteur, par taille, par structure.",
      viewSolution: "Voir la solution →",
      viewAll: "Toutes les solutions →",
    },
    servicesOverview: {
      eyebrow: "Services",
      title: "Besoin de quelque chose de bâti ? Nous le faisons aussi.",
      intro:
        "ESTINAD est aussi une entreprise de livraison logicielle sur mesure. Quand un produit prêt ne convient pas, nous concevons et bâtissons l'application, le site ou l'écosystème dont vous avez besoin — avec la même discipline d'ingénierie que nos produits.",
      viewAll: "Explorer les services →",
      items: [
        { slug: "custom-software", t: "Développement logiciel sur mesure", d: "Des applications sur mesure bâties pour vos flux, vos utilisateurs et votre échelle." },
        { slug: "websites", t: "Création de sites web", d: "Des sites web premium, rapides et multilingues — de la présence d'entreprise aux plateformes complexes." },
        { slug: "ecosystems", t: "Écosystèmes de bout en bout", d: "Des systèmes numériques complets qui connectent produits, travaux sur mesure et outils en un tout cohérent." },
        { slug: "integrations", t: "Intégrations", d: "Connectez ESTINAD à vos outils existants — paiements, comptabilité, livraison et plus." },
      ],
    },
    caseStudiesOverview: {
      eyebrow: "Études de cas",
      title: "Des preuves — produits adoptés et systèmes bâtis.",
      intro:
        "Travaux clients réels et adoption produit réelle. Des applications sur mesure et des sites web aux écosystèmes complets bâtis de bout en bout.",
      viewAll: "Voir toutes les études de cas →",
      cases: [
        { sector: "Commerce · 6 sites", result: "Clôture quotidienne passée de 90 à 15 minutes", body: "Un détaillant de prêt-à-porter a migré six points de vente vers ESTINAD Commerce et ESTINAD Cloud, abandonnant trois installs de caisse et une réconciliation Excel nocturne.", metric: "−83 %", metricLabel: "temps de clôture quotidienne", tag: "Adoption produit" },
        { sector: "Restauration · 4 sites", result: "Menu central et visibilité des marges en une vue", body: "Un groupe de restauration a unifié le menu et le coût matière sur quatre sites, remplaçant tickets papier et caisses déconnectées par un seul flux.", metric: "1 menu", metricLabel: "sur tous les sites", tag: "Adoption produit" },
        { sector: "Build sur mesure · PME", result: "Une plateforme opérationnelle sur mesure, livrée de bout en bout", body: "Nous avons conçu et bâtis une plateforme opérationnelle sur mesure pour une PME multi-sites dont les besoins n'étaient couverts par aucun produit du marché — du cahier des charges au lancement au support.", metric: "De bout en bout", metricLabel: "bâti & supporté", tag: "Logiciel sur mesure" },
      ],
    },
    why: {
      eyebrow: "Pourquoi ESTINAD",
      title: "Produits plus capacité sur mesure. Un partenaire discipliné.",
      intro: "ESTINAD s'adresse aux dirigeants qui veulent un logiciel aussi sérieux que leur entreprise — qu'ils adoptent un produit ou commandent un build.",
      items: [
        { t: "Produits + sur mesure", d: "Achetez un produit prêt ou laissez-nous bâtir le système dont vous avez besoin. Peu d'entreprises font les deux, moins le font bien." },
        { t: "Compréhension métier", d: "Nous bâtissons pour le commerce, la restauration, les pharmacies, les cliniques et les PME parce que nous comprenons comment ils fonctionnent." },
        { t: "Logique logiciel évolutif", d: "Une entreprise product-led, qui pense plateforme — pas un atelier de projets. Ce que nous bâtissons est fait pour durer et grandir." },
        { t: "Pensée modulaire", d: "Commencez avec un produit ou un build. Ajoutez modules, intégrations et sites sur la même fondation." },
        { t: "Force d'exécution", d: "Nous livrons. Cahier des charges, build, déploiement, support — et nous restons responsables du résultat." },
        { t: "Partenariat de long terme", d: "Nous restons après le lancement. Le logiciel évolue avec l'entreprise et ses marchés." },
      ],
    },
    howWeWork: {
      eyebrow: "Comment nous travaillons",
      title: "Un processus simple et sérieux — pour les produits comme pour les builds sur mesure.",
      intro: "Que vous adoptiez un produit ou commandiez un système sur mesure, le chemin est le même : comprendre, recommander, bâtir, supporter.",
      steps: [
        { n: "01", t: "Comprendre", d: "Nous apprenons votre entreprise, vos sites, vos outils et le problème que vous devez réellement résoudre." },
        { n: "02", t: "Recommander", d: "Nous proposons la bonne voie — un produit prêt, un build sur mesure, ou une combinaison — avec un périmètre et un plan clairs." },
        { n: "03", t: "Bâtir / Déployer", d: "Nous configurons le produit ou bâtissons et livrons le système, avec un déploiement adapté à vos conditions réelles." },
        { n: "04", t: "Supporter / Grandir", d: "Nous restons après le lancement — support, intégration et extension au fil de la croissance." },
      ],
    },
    finalCta: {
      eyebrow: "Prochaine étape",
      title1: "Appuyez-vous sur du logiciel prêt — ou laissez-nous le",
      titleAccent: " bâtir",
      title2: " pour vous.",
      sub: "Explorez nos produits, ou parlez-nous du système dont vous avez besoin. Dans les deux cas, vous travaillez avec une seule entreprise logicielle qui fait les deux.",
      cta1: "Explorer les produits →",
      cta2: "Discuter de votre projet",
      cta3: "Demander une démo →",
    },
